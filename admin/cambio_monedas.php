...
function cambio_moneda_process_cambio_moneda() {
	...
	if ( isset( $_POST['tipoCambioDesdeSelect'] ) ) {
		...
		{
			$mensajeValidacion = esc_html__("El valor introducido no es numérico", "cambio_monedas");
			$esValido = false;
		}
...
function cambio_moneda_display_page() {
	...
	<div class="wrap">
		...
		<?php cambio_moneda_form_cambio_moneda(); ?>
		<?php cambio_moneda_process_cambio_moneda(); ?>
